...
internal class StartBulkSimulationCommandHandlerTest {
  ...
  @Test
  fun `should persist document and publish simulation message`() = runBlocking {
    val bulkId = UUID.randomUUID()
    val customerInfo = CustomerInfo(LocalDate.of(1990, 1, 1), "cliente@teste.com")

    val dto = LoanSimulationCommandDto(
    ...
    val command = StartBulkSimulationCommand(
      bulkId = bulkId,
    ...
    } returns BulkSimulationDocument(
      id = bulkId,
